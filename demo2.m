...
dim=[100 100 100];
tiss_prop(1,1).musv = 10;
tiss_prop(1,1).muav = 0.05;
tiss_prop(1,1).gv = 0;
...
optpos = [0  0  .1;  1.4 0 .1;  1.9 0 0.1 ;2.5 0 0.1;  2.9 0 0.1];
%filename='sample_30';
...
ndet=size(det,1);
  ...
  %  v = c/n;
  tic;
mcxyz_ejecutor(filename, Nphoton, dim, optpos, tiss_prop, 1);
time_ejec=toc;
